...
spring:
    ...
    datasource:
        name: website
        url: jdbc:mysql://127.0.0.1:3306/hd_logistics_agent?useUnicode=true&characterEncoding=utf8&useSSL=false&zeroDateTimeBehavior=convertToNull&serverTimezone=Asia/Shanghai
        username: root
        password: 9ox654321
...
netp:
  upload:
    ...
    dir: /root/upload/logisticsagent/file

      
# 单点信息配置，全部可无
kisso:
  config:
    signkey: C791d971EJ3H376G81
    cookieName: kisso
